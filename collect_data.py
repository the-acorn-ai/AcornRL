...
def main():
    ...
    parser.add_argument("--tensor-parallel-size", type=int, required=False, default=1, help="The number of GPUs to use")
    ...
    with VLLMCollector(
        ...
        max_new_tokens=args.max_seq_len, max_workers=args.max_workers, tensor_parallel_size=args.tensor_parallel_size
    ) as collector:
